...
def create_app(test_config=None):
  ...
  def drop_question(question):
    ...
    try:
      deleted_question = Question.query.get(question)
  ...
  def play_quiz():
    ...
    try:
      ...
      play_question = questions[random.randrange(0,len(questions))].format() if len(questions) > 0 else None
